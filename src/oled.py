...
_REPLACES = {
    192: 'A', 193: 'A', 194: 'A', 195: 'A', 196: 'A', 197: 'A', 198: 'A', 199: 'C', 200: 'E', 201: 'E', 202: 'E', 203: 'E', 204: 'I',
    ...
    335: 'o', 336: 'O', 337: 'o', 340: 'R', 341: 'r', 342: 'R', 343: 'r', 344: 'R', 345: 'r', 346: 'S', 347: 's', 348: 'S', 349: 's',
    350: 'S', 351: 's', 352: 'S', 353: 's', 354: 'T', 355: 't', 356: 'T', 357: 't', 358: 'T', 359: 't', 360: 'U', 361: 'u', 362: 'U',
    363: 'u', 364: 'U', 365: 'u', 366: 'U', 367: 'u', 368: 'U', 369: 'u', 370: 'U', 371: 'u', 372: 'W', 373: 'w', 374: 'Y', 375: 'y',
...
class OLED:
    ...
    def __init__(self, scl_pin = 22, sda_pin = 21, contrast = 127, enable = True):
        ...
        self._cache_artist_raw = None
        self._cache_title_raw = None
        self._cache_artist_lines = None
        self._cache_title_lines = None
    ...
    def show(self, artist, title, progress = None, ticks = True, separator = True):
        ...
        if artist_raw == self._cache_artist_raw and title_raw == self._cache_title_raw and self._cache_artist_lines is not None and self._cache_title_lines is not None:
            a = self._cache_artist_lines
            t = self._cache_title_lines
        else:
            cols = int(self.oled_width / 8)
            a = textutils.wrap(self._replace_chars(artist_raw), width = cols, center = True)
            t = textutils.wrap(self._replace_chars(title_raw), width = cols, center = True)
            self._cache_artist_raw = artist_raw
            self._cache_title_raw = title_raw
            self._cache_artist_lines = a
            self._cache_title_lines = t
